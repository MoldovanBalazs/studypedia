...
export const DEADLINES: Curricula[] = [
  ...
  {name : 'OOP lab evaluation', deadline : new Date("2018-08-15T14:45:00-00:00"), timeRemaining : new Duration()},
  {name : 'OS homework', deadline : new Date("2018-08-02T09:15:00-00:00"), timeRemaining : new Duration()},
